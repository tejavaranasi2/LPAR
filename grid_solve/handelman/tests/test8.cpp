...
int main(int argv, char* argc[]){
   ...
   int ctr_i=1;
    ...
    std::vector<std::vector<double> > coeff={{1,2,1,2},{2,1,1,2},{3,1,3,1}};
    ...
    for(int i=0;i<2;i++){
        ...
        e_c[0]=(((v[0]*-1+circles[i][0]))*(coeff[i][0])+((v[1]*-1+circles[i][1]))*(coeff[i][1])+((v[2]*-1+circles[i][2]))*(coeff[i][2])+((v[3]*-1+circles[i][3]))*(coeff[i][3]))*(-1)+(circles[i][4]);
