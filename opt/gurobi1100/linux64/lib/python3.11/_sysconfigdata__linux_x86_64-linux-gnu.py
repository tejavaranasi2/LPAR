...
build_time_vars = {'ABIFLAGS': '',
 ...
 'CONFIG_ARGS': "'--prefix=/usr/local' '--with-openssl=/usr' "
                "'--with-openssl-rpath=auto'",
 'CONFINCLUDEDIR': '/usr/local/include',
 'CONFINCLUDEPY': '/usr/local/include/python3.11',
 'COREPYTHONPATH': '',
 'COVERAGE_INFO': '/software/pythons/Python-3.11.4/coverage.info',
 'COVERAGE_LCOV_OPTIONS': '--rc lcov_branch_coverage=1',
 'COVERAGE_REPORT': '/software/pythons/Python-3.11.4/lcov-report',
 ...
 'MODULE__HASHLIB_LDFLAGS': '-L/usr/lib  '
                            '-Wl,--enable-new-dtags,-rpath=/usr/lib  -lcrypto',
 ...
 'MODULE__SSL_LDFLAGS': '-L/usr/lib  -Wl,--enable-new-dtags,-rpath=/usr/lib '
                        '-lssl -lcrypto',
 ...
 'abs_builddir': '/software/pythons/Python-3.11.4',
 'abs_srcdir': '/software/pythons/Python-3.11.4',
