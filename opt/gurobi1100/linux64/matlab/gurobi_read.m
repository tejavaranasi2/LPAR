...
%    <a href="matlab:web(fullfile(fileparts(which('gurobi')), 'html', 'index.html'))">included html documentation</a>, and on-line at the <a href="matlab:web('https://www.gurobi.com/documentation/11.0/refman/matlab_api_overview.html')">Gurobi Documentation</a> page.
%
